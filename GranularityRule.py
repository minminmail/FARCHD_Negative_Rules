        ...
        for i in range(0, self.negative_rule_number):
            for dr in range(0, data_row_number):
                ...
                if same_label_num == number_label_of_rule:
                    ...
                    output[i].append(train.get_output_as_string_with_pos(dr))
